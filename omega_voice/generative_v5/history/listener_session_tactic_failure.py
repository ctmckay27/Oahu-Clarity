...
def main():
 ...
 {'id':'new_listener','text':'Please keep this door open. I need room to move the case.', 'scene':{'events':[
 event('listener','Mari turns to a porter she has just met.',listener_id='porter'),
 event('action','Mari requests practical help from the porter.',tactic='request',target='porter')]}}]
 ...
 for i,case in enumerate(cases):
  ...
  try:
   receipt=session.render_turn(case['id'],case['text'],case['scene'],96700+i,diagnostic=True)
