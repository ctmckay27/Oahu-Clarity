...
def main():
 ...
 commands=[[a.cmake,'-S',str(e),'-B',str(e/'build'),'-DCMAKE_BUILD_TYPE=Release','-DGGML_CUDA=OFF','-DGGML_METAL=OFF','-DLLAMA_CURL=OFF','-DLLAMA_BUILD_TESTS=OFF'],[a.cmake,'--build',str(e/'build'),'--target','mari-audio-critic','-j4']]
